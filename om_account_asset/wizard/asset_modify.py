...
class AssetModify(models.TransientModel):
    ...
    name = fields.Text(string='Raison', required=True)
    method_number = fields.Integer(string="Nombre d'amortissements", required=True)
    method_period = fields.Integer(string="Durée de la période")
    method_end = fields.Date(string='Fin')
    asset_method_time = fields.Char(compute='_get_asset_method_time', string="Temps de méthode d'actif", readonly=True)
    ...
    def modify(self):
        """ Modifie la durée de l'actif pour le calcul de l'amortissement
            et maintient l'histoire des anciennes valeurs, dans le bavardage.
        """
