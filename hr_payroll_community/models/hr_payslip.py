...
class HrPayslip(models.Model):
    ...
    number = fields.Char(string='Reference', readonly=True, copy=False, help="References", required=True, index=True, default=lambda self: _('New'),
    ...
    def create(self, vals):
        if vals.get('number', _('New')) == _('New'):
            vals['number'] = self.env['ir.sequence'].next_by_code('hr_payslip_sequence') or _('New')
