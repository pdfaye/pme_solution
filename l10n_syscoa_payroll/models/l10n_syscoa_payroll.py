...
from odoo.addons.base.models.decimal_precision import get_precision
...
class HrContract(models.Model):
    ...
    additional_salary = fields.Float(
        "Sursalaire", digits_compute=get_precision("Payroll")
    )

    union_fee = fields.Float(
        "Cotisation syndicale", digits_compute=get_precision("Payroll")
    )

    performance_bonus = fields.Float(
        "Prime de rendement", digits_compute=get_precision("Payroll")
    )
    gratification = fields.Float(
        "Gratification", digits_compute=get_precision("Payroll")
    )
    ...
    seniority_date_manual_input = fields.Date(
        "Date de début",
        digits_compute=get_precision("Payroll"),
    ...
    risk_bonus = fields.Float(
        "Prime de risque", digits_compute=get_precision("Payroll")
    )
    home_bonus = fields.Float(
        "Prime de logement", digits_compute=get_precision("Payroll")
    )
    cashpoint_bonus = fields.Float(
        "Prime de caisse", digits_compute=get_precision("Payroll")
    )
    expatriation_bonus = fields.Float(
        "Prime d'expratriation", digits_compute=get_precision("Payroll")
    )
    basket_bonus = fields.Float(
        "Prime de panier", digits_compute=get_precision("Payroll")
    )
    responsability_bonus = fields.Float(
        "Prime de responsabilité", digits_compute=get_precision("Payroll")
    )
    subjection_allowance = fields.Float(
        "Indemnité de sujétion", digits_compute=get_precision("Payroll")
    )

    food_advantage = fields.Float(
        "Avantage pour nourriture", digits_compute=get_precision("Payroll")
    )
    ...
    family_advantage = fields.Float(
        "Avantages familiaux", digits_compute=get_precision("Payroll")
    )
    company_car_advantage = fields.Float(
        "Avantage pour véhicule de fonction", digits_compute=get_precision("Payroll")
    )
    company_phone_advantage = fields.Float(
        "Avantage pour téléphone", digits_compute=get_precision("Payroll")
    )
    ...
    kilometer_refund = fields.Float(
        "Indemnité kilométrique", digits_compute=get_precision("Payroll")
    )
    transport_refund = fields.Float(
        "Indemnité de transport", digits_compute=get_precision("Payroll")
    )
    ...
    meal_voucher = fields.Float(
        "Bons de repas", digits_compute=get_precision("Payroll")
    )
    ...
    dirtiness_allowance = fields.Float(
        "Prime de salissure", digits_compute=get_precision("Payroll")
    )
...
class HrPayslip(models.Model):
    ...
    quantity_delivred = fields.Float(
        ...
        method=True,
        digits_compute=get_precision("Product UoS"),
        store=True,
    )
...
class HrPayslipLine(models.Model):
    ...
    rate2 = fields.Float(
        "Rate2 (%)", digits_compute=get_precision("Payroll Rate"), default=100.0
    )
    amount2 = fields.Float("Amount2", digits_compute=get_precision("Payroll"))
    quantity2 = fields.Float(
        "Quantity2", digits_compute=get_precision("Payroll"), default=1.0
    )
    total2 = fields.Float(
